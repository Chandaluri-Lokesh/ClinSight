...
Hospital-grade Clinical Decision Support System (CDSS) **frontend only**. Built with React, TypeScript, Tailwind CSS, and the design system in `../design.json`.

## Design

- **UX spec:** See `../FRONTEND_DESIGN.md` for screen-by-screen UX, roles, and edge states.
- **Design system:** Colors, typography, and components follow `../design.json` (teal primary, Inter, cards, sidebar, table).
...
- React Router 6
- Tailwind CSS (tokens from design.json)
- Lucide React (icons per design.json)
