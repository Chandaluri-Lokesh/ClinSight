...
import { UserPlus, Upload, Users, Stethoscope, ShieldCheck, ClipboardList } from 'lucide-react'
...
const SHORTCUTS: { path: string; label: string; description: string; icon: React.ElementType; roles: Role[] }[] = [
  ...
  { path: '/worklist', label: 'Diagnostic Support', description: 'Request decision support', icon: Stethoscope, roles: ['physician'] },
