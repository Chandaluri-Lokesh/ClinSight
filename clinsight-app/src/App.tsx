...
import DiagnosticSupportLookup from './screens/DiagnosticSupportLookup'
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="diagnostic-lookup" element={<PrivateRoute allowedRoles={['physician']}><DiagnosticSupportLookup /></PrivateRoute>} />
